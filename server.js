...
function loadDatabase(){
    let database = yaml.safeLoad(fs.readFileSync('database.yml', 'utf8'));
...
function saveDatabase(){
  let content = yaml.safeDump(database);
  fs.writeFileSync('database.yml', content);
  console.log(content);
}
